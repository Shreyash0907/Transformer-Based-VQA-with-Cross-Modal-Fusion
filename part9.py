...
def train_model_main(device, tknzer, img_transfrm):
    ...
    print("Starting part 9: Training")
...
def inference_model_main(device, tknzer, img_transfrm):
    ...
    print("\nTest Set A Results (part 9 - Inference Mode)")
    metrics = {
        "Accuracy": tst_acc,
        "Precision": tst_prec,
        "Recall": tst_recall,
    ...
    print("\npart 9 inference script finished")

def main():
    parser = argparse.ArgumentParser(description="VQA Model part 9: Training and Inference")
