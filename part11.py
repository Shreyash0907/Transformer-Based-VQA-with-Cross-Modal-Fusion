...
def inference_model_main(device, tknzer, img_transfrm):
    ...
    print("Starting part 11: Inference")
    ...
    imagedirectory = os.path.join(dset_path, "images", "testB")
    questionpath = os.path.join(dset_path, "questions", "CLEVR_testB_questions.json")
    test_data = Data(imagedirectory, questionpath, tknzer, ans_to_idx, mx_len, img_transfrm)
    print("image directory ", imagedirectory)
    print("question directory ", questionpath)
    ...
    vis_pred(mdl, test_data, idx_to_ans, device, n_samples=5, find_errs=False, sv_dir=viz_sv_dir, part_name="part11_inference_testB")
    vis_pred(mdl, test_data, idx_to_ans, device, n_samples=5, find_errs=True, sv_dir=viz_sv_dir, part_name="part11_inference_testB")
    
    print("\npart 11 inference script finished")

def main():
    parser = argparse.ArgumentParser(description="VQA Model part 11: Training and Inference")
    ...
    if args.mode == 'inference':
        ...
        print("argument mode is incorrect")
